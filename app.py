...
with col2:
    ...
    st.expander("What happens to the uploaded data?", expanded=False).markdown("""All your data is contained in your isolated private session. After session end everything is deleted.""")
